...
HelpUri: https://pwshspectreconsole.com/reference/prompts/read-spectreselectiongrouped/
Locale: en-US
...
```
Read-SpectreSelectionGrouped [[-Message] <string>] [-Choices] <hashtable>
 [[-ChoiceLabelProperty] <string>] [[-Color] <Color>] [[-PageSize] <int>] [[-TimeoutSeconds] <int>]
 [[-SearchHighlightColor] <Color>] [-EnableSearch] [<CommonParameters>]
```
