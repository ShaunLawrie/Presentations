...
$script:CharacterPosition = @{
    ...
    PreviousY = [int](($script:Height * 2) - $script:YStepSize - 4)
    NextX = [int]($script:Width / 2) - 6
    NextY = [int](($script:Height * 2) - $script:YStepSize - 4)
    Hidden = $false
}
...
"@,
@"
So you think you know some PowerShell.
How about you face my top 3 challenges!


"@,
@"
My first challenge is to properly use arrays!
